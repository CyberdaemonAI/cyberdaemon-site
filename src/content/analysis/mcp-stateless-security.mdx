...
I run MCP servers in production across a Kubernetes environment. They expose tools for episodic memory, project tracking, vector search, fleet management, and more. My agents use these tools daily. This is not a spec critique from the sidelines. This is an operator report.
