...
excerpt: "NIST AI 100-1 is well-structured, well-intentioned, and almost entirely theoretical in most organizations."
date: 2026-08-30
tags: ["research"]
...
- [Zero Trust Applied to AI Systems](/research/zt-ai-systems) — NIST SP 800-207 as a companion framework. Where AI RMF governs risk management lifecycle, ZTA governs the access control architecture. The two frameworks are complementary, not redundant.
- [Human Above the Loop](/analysis/human-above-the-loop) — the Govern function of AI RMF requires human policy authorship, not human approval of every action. This article works through what that means operationally.
- [Dual-Intent Runtime Authorization (DIRA)](/research/dira-framework) — the Measure and Manage functions of AI RMF need runtime primitives. DIRA is a candidate for the intent verification gap.
- [NIST AI RMF](/research/nist-ai-rmf-practice) is the governance wrapper; [Non-Human Identity for Agentic Systems](/research/nhi-agentic) is the identity prerequisite the framework assumes but doesn't specify.
