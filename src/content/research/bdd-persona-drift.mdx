...
- [prom-memory: building episodic memory for an AI system that actually remembers](/build-logs/prom-memory) — the memory system the Elliot Probe monitors. The structural baseline is built from prom-memory's fact type taxonomy.
