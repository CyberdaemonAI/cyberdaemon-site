...
- [Hardening an Autonomous Agent Fleet](/build-logs/agent-fleet-security-hardening) — egress controls, credential monitoring, and what NHI lifecycle management looks like in a running K3s cluster.
