...
excerpt: "If the only way to check the constraint is to ask the AI whether it passed, you haven't built a constraint. You've built a question."
date: 2026-09-01
tags: ["ai-systems", "ai-security"]
