...
excerpt: "The contamination surface isn't one pipe. It's the mesh. Standard pipeline security thinking doesn't apply."
date: 2026-09-01
...
<PullQuote>The contamination surface isn't one pipe. It's the mesh. Standard pipeline security thinking doesn't apply.</PullQuote>
...
- **Part 7: [In Plain Language](/research/cognitive-security-part7)** — Behavioral constraints for multi-agent memory.

The multi-agent identity problem at the memory layer is the same problem described from the authorization side in [Non-Human Identity for Agentic Systems](/research/nhi-agentic) and [Dual-Intent Runtime Authorization](/research/dira-framework).
