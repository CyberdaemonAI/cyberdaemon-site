...
excerpt: "A persona without state is a character sheet, not a character. Characters are defined by how they respond to what is happening around them."
date: 2026-08-30
tags: ["ai-systems"]
...
- [the memory layer: building episodic memory for an AI system that actually remembers](/build-logs/prom-memory) — PADCN reads affective state from the memory layer. It is the substrate PADCN operates against.
