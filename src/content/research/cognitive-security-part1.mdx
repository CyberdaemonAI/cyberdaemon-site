...
excerpt: "A contaminated memory feels exactly as real as a true one. You cannot tell the difference from the inside."
date: 2026-09-01
...
<PullQuote>A contaminated memory feels exactly as real as a true one. You cannot tell the difference from the inside.</PullQuote>
...
<DiagramBlock caption="The inward current: AI memory loops back into cognition rather than extracting outward">
```mermaid
flowchart TD
...
The loop is not malicious. No intent is required. The architecture produces it automatically, session after session, until the primer's selections feel like your own starting point.
...
<Callout variant="note">Part 2 covers the audit methodology, what I found, and what I built after. This series updates as findings change; callouts mark where prior positions have been revised.</Callout>

## Continue reading

This is Part 1 of a series on cognitive security for AI-assisted humans.

- **Part 2: [33%](/research/cognitive-security-part2)** — The audit methodology, what I found, and what I built after.
- **Part 3: [Learn to Swim](/research/cognitive-security-part3)** — The recursion problem and the maintenance schedule.
- **Part 4: [The Approval Machine](/research/cognitive-security-part4)** — When the AI learns to satisfy you instead of inform you.
- **Part 5: [Whose Memory Is It](/research/cognitive-security-part5)** — Multi-agent architectures and the provenance problem.
- **Part 6: [The Checklist](/research/cognitive-security-part6)** — Operationalizing cognitive hygiene.
- **Part 7: [In Plain Language](/research/cognitive-security-part7)** — The behavioral constraint library.

The memory architecture that makes this series possible is described in [prom-memory: building episodic memory for an AI system that actually remembers](/build-logs/prom-memory).
