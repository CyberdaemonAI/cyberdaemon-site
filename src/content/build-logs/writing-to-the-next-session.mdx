...
sequenceDiagram
    ...
    Note over Snap: next_action, dirty state, open questions<br/>recovery.confidence = null
...
<ScrollReveal>
<StatRow stats={[
  { value: "Every task", label: "Generates a handoff record" },
  { value: "Nightly", label: "Diagnostic agent reads corpus for patterns" },
  { value: "Monthly", label: "Spec improvement scan runs against gap data" }
]} />
</ScrollReveal>
